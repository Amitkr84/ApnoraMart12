...
urlpatterns = [
    ...
    path('vendor-add-product/', views.vendor_add_product_view, name='vendor-add-product'),
    path('vendor-signup/', views.vendor_signup_view, name='vendor-signup'),
    path('vendorlogin', views.vendor_login_view, name='vendorlogin'),
    ...
    path('give-feedback/<int:pk>', views.give_feedback_view, name='give-feedback'),

    # 🚀 RENDER PAR BROKEN IMAGES FIX (Media & Static Files Server)
